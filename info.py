...
BOT_TOKEN = environ.get('BOT_TOKEN', "5459553797:AAHuI82K3DVF7klRzFdXMtnY6ex6C-9nsXU")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001686416905').split()] #Channel id for auto indexing ( make sure bot is admin )
...
HOWTOVERIFY = environ.get('HOWTOVERIFY','https://t.me/lovetoride') # How to open tutorial link for verification

# Others
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'earnwithlink.com')
SHORTLINK_API = environ.get('SHORTLINK_API', '5ef9638462736b0bf451579cd14d030da36f9f81')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001366123484')) #Log channel id ( make sure bot is admin )
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001366123484'))
